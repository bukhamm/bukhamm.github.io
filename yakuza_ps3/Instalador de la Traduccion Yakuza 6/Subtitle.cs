    ...
    public class Subtitle //: TF.Core.TranslationEntities.Subtitle
    {
        ...
        public MsgProperties TranslationProperties
        {
            get
            {
                ...
                var translationProperties = ExtractProperties("cambiar con la variable que corresponda");
        ...
        public Subtitle(string text, bool removeLineBreaks, bool removeTags)
        {
           // Offset = s.Offset;
           // Text = s.Text;
        ...
        {
            return Clean("cambiar con la variable que corresponda = Text", true, true);
        }

        public string CleanTranslation()
        {
            return Clean("cambiar con la variable que corresponda", true, true);
        }
